module Ex26
  ...
  def Ex26.puts_first_word(words)
    word = words.shift
    puts word
  end

  # Prints the last word after popping it off.
  def Ex26.puts_last_word(words)
    word = words.pop
    puts word
  end
  ...
  def Ex26.puts_first_and_last(sentence)
    words = break_words(sentence)
  ...
  def Ex26.puts_first_and_last_sorted(sentence)
...
puts "We'd have #{jelly_beans}, #{jars} jars, and #{crates} crates."
